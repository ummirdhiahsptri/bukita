                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $row['username'];?></td>
                            <td>
                                <a href="<?= base_url; ?>/user/edit/<?= $row['id'] ?>" class="badge badge-info">Edit<a> <a href="<?= base_url; ?>/user/hapus/<?= $row['id'] ?>" class="badge badgedanger"onclick="return confirm('Hapus data?');">Hapus</a>
                            </td>
                        </tr>
                        <?php $no++; endforeach; ?>
                    </tbody>
