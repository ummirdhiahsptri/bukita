<?php
    class BukuModel {
        ...
        {
        $this->db->query("SELECT buku.*, kategori.nama_kategori FROM " . $this->table . " LEFT JOIN kategori ON kategori.id = buku.kategori_id");
        ...
        {
            $key = $_POST['key'];
            $this->db->query('SELECT * FROM ' . $this->table . ' LEFT JOIN kategori ON buku.kategori_id = kategori.id WHERE judul LIKE :key');
